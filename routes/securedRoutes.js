...
const AddNewsletterContent = lazy(() => import('../components/newsletter/AddNewsletterContent'));
const Surveys = lazy(() => import('../components/surveys/Surveys'));
const SurveysForm = lazy(() => import('../components/surveys/SurveysForm'));
...
const newsletterTemplatesRoutes = [
  ...
  {
    path: '/newsletters/content/:id',
    name: 'Newsletters Content',
    exact: true,
    element: AddNewsletterContent,
    roles: ['Admin'],
    isAnonymous: true,
  },
  {
    path: '/newsletters/content',
    name: 'Newsletters Content',
    exact: true,
    element: AddNewsletterContent,
    roles: ['Admin'],
